...
import { FetchSingleApplication } from "../../fetch/get/application/FetchSingleApplication";
import { Button } from "../../ui/button";
import Preview from "../singleApplication/preview/Privew";
        ...
        <>
          ...
          <Formik
            initialValues={{
              ...
              fatherName: data.application.fatherName,
              motherName: data.application.motherName,
              birthDay: data.application.birthDay,
              bloodGroup: data.application.bloodGroup,
              mobileNumber: data.application.mobileNumber,
              guardianNumber: data.application.guardianNumber,
              gender: data.application.gender,
              religion: data.application.religion,
              fullAddress: data.application.fullAddress,
              district: data.application.district,
              email: data.application.email,
              pc: data.application.pc,
              education: data.application.education,
              board: data.application.board,
              rollNumber: data.application.rollNumber,
              regNumber: data.application.regNumber,
              passingYear: data.application.passingYear,
              gpa: data.application.gpa,
              nid: data.application.nid,
              nationality: data.application.nationality,
              course: data.application.course,
              duration: data.application.duration,
              transactionId: data.application.transactionId,
              fatherOccupation: data.application.fatherOccupation,
          ...
          >
            <Form className="mx-auto flex w-11/12 flex-col gap-6 lg:w-3/4">
              <div className=" right-20 top-64 border border-primary lg:absolute">
