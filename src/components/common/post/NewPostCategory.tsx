...
const NewPostCategories: FC<CategoriesProps> = ({ onChange, error }) => {
  ...
  return (
    <div className="mb-4">
      <label className="mb-2 block font-bold" htmlFor="categories">
        Categories
      </label>
      <select
        className="mt-2 block w-10/12 rounded-md border border-gray-300 bg-slate-700 px-4 py-2 text-gray-100 "
        id="categories"
        onChange={onChange}
      >
